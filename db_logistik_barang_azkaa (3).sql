...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2026 at 12:48 PM
...
(1363, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-16 06:47:21'),
(1364, 8, NULL, 'Login', 'User Alif berhasil login', '2026-04-16 06:47:26'),
(1365, 8, NULL, 'Logout', 'User Alif berhasil logout', '2026-04-16 06:54:07'),
(1366, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-16 06:54:36'),
(1367, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-16 07:08:21'),
(1368, 10, NULL, 'Login', 'User Fauzan berhasil login', '2026-04-16 07:08:35'),
(1369, 10, NULL, 'Logout', 'User Fauzan berhasil logout', '2026-04-16 07:12:18'),
(1370, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-16 07:12:28'),
(1371, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-16 07:20:42'),
(1372, 10, NULL, 'Login', 'User Fauzan berhasil login', '2026-04-16 07:20:45'),
(1373, 10, NULL, 'Logout', 'User Fauzan berhasil logout', '2026-04-16 07:20:51'),
(1374, 8, NULL, 'Login', 'User Alif berhasil login', '2026-04-16 07:20:59'),
(1375, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 06:26:50'),
(1380, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 06:35:40'),
(1381, 10, NULL, 'Login', 'User Fauzan berhasil login', '2026-04-22 06:35:46'),
(1385, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 06:36:10'),
(1386, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 06:36:14'),
(1387, 10, NULL, 'Login', 'User Fauzan berhasil login', '2026-04-22 06:36:18'),
(1390, 10, NULL, 'Logout', 'User Fauzan berhasil logout', '2026-04-22 06:36:29'),
(1391, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 06:36:32'),
(1392, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 06:36:50'),
(1393, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 06:36:55'),
(1394, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 06:37:00'),
(1395, 10, NULL, 'Login', 'User Fauzan berhasil login', '2026-04-22 06:37:04'),
(1398, 10, NULL, 'Logout', 'User Fauzan berhasil logout', '2026-04-22 06:37:50'),
(1399, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 06:37:54'),
(1402, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 06:51:57'),
(1403, 10, NULL, 'Login', 'User Fauzan berhasil login', '2026-04-22 06:52:01'),
(1404, 10, NULL, 'Logout', 'User Fauzan berhasil logout', '2026-04-22 06:55:14'),
(1405, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 06:55:18'),
(1406, 1, 110, 'Driver Fauzan assigned ke paket AE-1776840595-792', 'DRIVER_ASSIGNED', '2026-04-22 06:55:28'),
(1407, 1, 109, 'Driver Fauzan assigned ke paket AE-1776840556-767', 'DRIVER_ASSIGNED', '2026-04-22 06:55:35'),
(1408, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 06:55:38'),
(1409, 10, NULL, 'Login', 'User Fauzan berhasil login', '2026-04-22 06:55:42'),
(1410, 10, NULL, '📦Paket Pickup di Gudang Surabaya Pusat | AE-1776840556-767', 'PICKUP', '2026-04-22 06:55:59'),
(1411, 10, NULL, '📦Paket Pickup di Gudang Surabaya Pusat | AE-1776840595-792', 'PICKUP', '2026-04-22 06:55:59'),
(1412, 10, NULL, '🚚 Paket Berangkat dari Gudang Surabaya Pusat | AE-1776840556-767', 'ON_DELIVERY', '2026-04-22 06:56:05'),
(1413, 10, NULL, '🚚Paket Berangkat dari Gudang Surabaya Pusat | AE-1776840595-792', 'ON_DELIVERY', '2026-04-22 06:56:05'),
(1414, 10, NULL, '📍 Paket Tiba di gudang Gudang Kota Cimahi | AE-1776840556-767', 'TRANSIT_HUB', '2026-04-22 06:56:15'),
(1415, 10, NULL, 'Logout', 'User Fauzan berhasil logout', '2026-04-22 06:56:18'),
(1416, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 06:56:22'),
(1417, 10, NULL, '📍 Paket Tiba di gudang Gudang Kota Cimahi | AE-1776840595-792', 'ON_DELIVERY', '2026-04-22 06:56:15'),
(1418, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 07:59:10'),
(1419, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 07:59:17'),
(1420, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 08:04:30'),
(1421, 8, NULL, 'Login', 'User Alif berhasil login', '2026-04-22 08:04:34'),
(1422, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 10:36:03'),
(1423, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 10:42:51');
INSERT INTO `tbl_activity_logs_azka` (`id_azka`, `user_id_azka`, `shipment_id_azka`, `actions_azka`, `reference_azka`, `created_at_azka`) VALUES
(1424, 26, NULL, 'Login', 'User chandraa berhasil login', '2026-04-22 10:42:56'),
(1425, 26, NULL, 'Logout', 'User chandraa berhasil logout', '2026-04-22 10:44:20'),
(1426, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 10:44:23'),
(1427, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 10:44:36'),
(1428, 26, NULL, 'Login', 'User chandraa berhasil login', '2026-04-22 10:44:39'),
(1429, 26, NULL, '📦 Paket sedang di sortir | AE-1776840556-767', '', '2026-04-22 10:45:20'),
(1430, 26, NULL, 'Logout', 'User chandraa berhasil logout', '2026-04-22 10:45:26'),
(1431, 1, NULL, 'Login', 'User Admin berhasil login', '2026-04-22 10:45:30'),
(1432, 1, NULL, 'Logout', 'User Admin berhasil logout', '2026-04-22 10:45:43'),
(1433, 8, NULL, 'Login', 'User Alif berhasil login', '2026-04-22 10:45:49'),
(1434, 8, NULL, 'Logout', 'User Alif berhasil logout', '2026-04-22 10:48:00'),
(1435, 26, NULL, 'Login', 'User chandraa berhasil login', '2026-04-22 10:48:09'),
(1436, 26, NULL, 'Logout', 'User chandraa berhasil logout', '2026-04-22 10:48:11'),
(1437, 8, NULL, 'Login', 'User Alif berhasil login', '2026-04-22 10:48:17'),
(1438, 8, NULL, 'Logout', 'User Alif berhasil logout', '2026-04-22 10:48:19');
...
CREATE TABLE `tbl_driver_scans_azka` (
  ...
  `warehouse_id_azka` int(11) DEFAULT NULL,
  `scan_type_azka` enum('IN','OUT','DROP') DEFAULT NULL,
...
(76, 10, 16, 'IN', '2026-04-22 13:55:59', -7.2489076, 112.7502949),
(77, 10, 16, 'OUT', '2026-04-22 13:56:05', -7.2489076, 112.7502949),
(78, 10, 18, 'DROP', '2026-04-22 13:56:15', -6.8786806, 107.5346253);
...
CREATE TABLE `tbl_shipment_azka` (
  ...
  `destination_warehouse_id_azka` int(11) DEFAULT NULL,
  `current_warehouse_id_azka` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_shipment_azka` (`id_azka`, `tracking_number_azka`, `sender_name_azka`, `qr_code_data_azka`, `receiver_name_azka`, `receiver_address_azka`, `warehouse_id_azka`, `courier_id_azka`, `driver_id_azka`, `status_azka`, `is_interisland`, `created_at_azka`, `updated_at_azka`, `origin_lat`, `origin_lng`, `last_lat`, `last_lng`, `destination_lat`, `destination_lng`, `receiver_city_azka`, `destination_warehouse_id_azka`, `current_warehouse_id_azka`) VALUES
(109, 'AE-1776840556-767', 'chandra', 'PAKET|109|AE-1776840556-767', 'azka', 'Jl. Kolonel Masturi, Gg. Masjid Nurul Arif, RT03/RW01, Kelurahan Citereup, Kec. Cimahi Utara, Kota Cimahi, Jawa Barat, 40512', 18, NULL, NULL, 'SORTING', 0, '2026-04-22 13:49:33', '2026-04-22 17:45:20', -7.2489076, 112.7502949, -7.2489076, 112.7502949, -6.8629111, 107.552033, 'CIMAHI', 18, 18),
(110, 'AE-1776840595-792', 'Azka', 'PAKET|110|AE-1776840595-792', 'Yoga', 'Jl. Pangauban, Perumahan Pangauban SIlih Asih Blok M No.58, Kec. Batujajar, Kab. Bandung Barat, Jawa Barat, 40561', 16, NULL, 10, 'ON_DELIVERY', 0, '2026-04-22 13:50:09', '2026-04-22 13:56:05', -7.2489076, 112.7502949, -7.2489076, 112.7502949, -6.915253, 107.4948945, 'BANDUNG BARAT', 20, 16);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_shipment_route_azka`
--

CREATE TABLE `tbl_shipment_route_azka` (
  `id_azka` int(11) NOT NULL,
  `shipment_id_azka` int(11) DEFAULT NULL,
  `city_azka` varchar(100) DEFAULT NULL,
  `lat_azka` decimal(10,8) NOT NULL,
  `lng_azka` decimal(11,8) NOT NULL,
  `status_azka` varchar(50) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tbl_shipment_route_azka`
--

INSERT INTO `tbl_shipment_route_azka` (`id_azka`, `shipment_id_azka`, `city_azka`, `lat_azka`, `lng_azka`, `status_azka`, `created_at`) VALUES
(1, 107, 'Gudang Surabaya Pusat', -7.24890760, 112.75029490, 'PICKED_UP', '2026-04-22 06:30:04'),
(2, 108, 'Gudang Surabaya Pusat', -7.24890760, 112.75029490, 'PICKED_UP', '2026-04-22 06:32:37'),
(3, 109, 'Gudang Surabaya Pusat', -7.24890760, 112.75029490, 'ORIGIN', '2026-04-22 06:49:33'),
(4, 109, 'Gudang Kota Cimahi', -6.87868060, 107.53462530, 'DESTINATION', '2026-04-22 06:49:33'),
(5, 110, 'Gudang Surabaya Pusat', -7.24890760, 112.75029490, 'ORIGIN', '2026-04-22 06:50:09'),
(6, 110, 'Gudang Kabupaten Bandung Barat', -6.91525300, 107.49489450, 'DESTINATION', '2026-04-22 06:50:09');
...
INSERT INTO `tbl_users_azka` (`id_azka`, `username_azka`, `email_azka`, `password_hash_azka`, `role_id_azka`, `warehouse_id_azka`, `created_at_azka`, `update_at_azka`, `is_active_azka`, `last_activity`) VALUES
(1, 'Admin', 'm.azkanabhan07@gmail.com', 'pbkdf2:sha256:1000000$sJt8RlYDDklN6ZGq$08f5b01cc2feff97c75b8b826bd003091a81a6d015566e101afbaa40222b2431', 1, NULL, '2025-11-28 07:57:41', '2026-04-22 10:45:43', 1, '2026-04-22 17:45:43'),
(7, 'fadlan', 'fadlan@gmail.com', 'pbkdf2:sha256:1000000$Br5EBARsNCgxSxfe$ccb32c800f4c64e3c1625ce015da2bab6b8a60bbfc006428256e8378a028ad19', 3, NULL, '2025-12-07 09:56:30', '2026-04-16 06:12:01', 1, '2026-04-06 21:08:00'),
(8, 'Alif', 'alif1@gmail.com', 'pbkdf2:sha256:1000000$HB9QcY1IwvWyFGcx$3a03f3911a259b4fdd984f02c13de79660a766c4e392500b051b6c7b3e071cf5', 2, 14, '2026-01-19 12:37:03', '2026-04-22 10:48:19', 1, '2026-04-22 17:48:19'),
(10, 'Fauzan', 'fauzan@gmail.com', 'pbkdf2:sha256:1000000$ZdQpvhRfyKrSihMT$2ed568da37120197f87a0e80cf788ab17ce0dc10eb9db6d15df15425cb8be0b5', 5, 16, '2026-02-12 12:35:17', '2026-04-22 06:56:18', 1, '2026-04-22 13:56:18'),
(11, 'Andi Santoso', 'andi@gmail.com', 'pbkdf2:sha256:1000000$stNFXFgEs8qlPUaQ$6c6dd3e30e645b57994e06759c925f4de2dcb27609e73fc452c540d0faea7ebb', 3, NULL, '2026-03-01 13:21:11', '2026-04-06 07:43:04', 1, '2026-04-06 14:43:04'),
(12, 'Suryana', 'surya@gmail.com', 'pbkdf2:sha256:1000000$Pd80MVIhyG7YyHOS$9549135a597aef8efb6cbe96c9c64c8a05f14df7e43ccf01e0d8e5ccd7a0d884', 3, NULL, '2026-03-01 13:25:11', '2026-04-06 08:34:13', 1, '2026-04-06 15:34:13'),
(13, 'Gilang Sugilang', 'gilang@gmail.com', 'pbkdf2:sha256:1000000$LvZqcxlf1YloE1xc$152676312fb7b29fb767969a37ddf7a4215a9aaa85f36c16bad9c1eba3266e01', 3, NULL, '2026-03-01 13:58:33', '2026-04-05 14:35:06', 1, '2026-04-05 21:35:06'),
(14, 'budi suparlan', 'budi@gmail.com', 'pbkdf2:sha256:1000000$jtDpXlglsD509Kjy$84d19a07c14b159d266ae7fad185407ea8d41ab2740791fd3fd6d7c504ccc738', 3, NULL, '2026-03-01 14:00:01', '2026-03-02 13:21:17', 1, '2026-03-02 20:21:17'),
(15, 'Sandi', 'sandi@gmail.com', 'pbkdf2:sha256:1000000$r9E3Bf6hPojO4va0$a094108f0e3743c5482bdaae3525840781de6b645ebbd0703032a77589ef2a70', 3, NULL, '2026-03-01 14:00:42', '2026-04-05 14:43:19', 1, '2026-04-05 21:43:19'),
(17, 'Yusuf Ismail', 'Yusuf@gmail.com', 'pbkdf2:sha256:1000000$zfvfcyAOMjvSCAr0$b39dfb3e6dc3b82ae4bd9abc470bf5496256b21d6dfa4c42cd64f2055ea48869', 5, 15, '2026-03-01 14:21:56', '2026-04-06 13:22:41', 1, '2026-04-06 20:22:41'),
(23, 'irsyad', 'irsyad@gmail.com', 'pbkdf2:sha256:1000000$OGOyV3bv3xBSPPqu$8b5b282667cb04a988abc9406be5c4ca1f0bec77fe1f94187e3ea79e7523aa45', 5, 14, '2026-04-06 14:01:37', '2026-04-06 14:01:37', 1, NULL),
(24, 'Fatir', 'fatir@gmail.com', 'pbkdf2:sha256:1000000$PhTsWhtwVXu4YFz5$1ef4ee150acc3823e32363fc5f1fa417acbca20e21c362cf39101e4ce02cdf73', 3, NULL, '2026-04-06 14:02:41', '2026-04-06 14:03:59', 1, '2026-04-06 21:03:59'),
(26, 'chandraa', 'chandra@gmail.com', 'pbkdf2:sha256:1000000$qaDaunxLeerDhX5U$2217d41d55ca719b8959b03a71587fba741d75b328376db2a51de3a58751b410', 2, 18, '2026-04-22 10:42:47', '2026-04-22 10:48:11', 1, '2026-04-22 17:48:11');
...
(14, 'Gudang Bandung Pusat', 'Jl. Otto Iskandar Dinata 509-535, Nyengseret, Kec. Astanaanyar, Kota Bandung, Jawa Barat 40242', 'GUDANG|14', '2026-02-05 10:08:02', -6.9088790, 107.6106028),
...
(35, 'Gudang Kota Bandung', '	Jl. Otto Iskandar Dinata 509-535, Nyengseret, Kec. Astanaanyar, Kota Bandung, Jawa Barat 40242', 'GUDANG|35', '2026-04-16 05:15:34', -6.9227611, 107.6181567);
...
--
-- Indexes for table `tbl_shipment_route_azka`
--
ALTER TABLE `tbl_shipment_route_azka`
  ADD PRIMARY KEY (`id_azka`),
  ADD KEY `shipment_id_azka` (`shipment_id_azka`);
...
--
ALTER TABLE `tbl_activity_logs_azka`
  MODIFY `id_azka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1439;
...
--
ALTER TABLE `tbl_driver_scans_azka`
  MODIFY `id_azka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT for table `tbl_products_azka`
--
ALTER TABLE `tbl_products_azka`
  MODIFY `id_azka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `tbl_shipment_azka`
  MODIFY `id_azka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;

--
-- AUTO_INCREMENT for table `tbl_shipment_route_azka`
--
ALTER TABLE `tbl_shipment_route_azka`
  MODIFY `id_azka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_users_azka`
  MODIFY `id_azka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `tbl_warehouses_azka`
--
ALTER TABLE `tbl_warehouses_azka`
  MODIFY `id_azka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
-- Constraints for table `tbl_shipment_route_azka`
--
ALTER TABLE `tbl_shipment_route_azka`
  ADD CONSTRAINT `fk_ship` FOREIGN KEY (`shipment_id_azka`) REFERENCES `tbl_shipment_azka` (`id_azka`);
COMMIT;
